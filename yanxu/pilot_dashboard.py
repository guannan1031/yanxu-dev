...
from .service import PostgresStore, Principal
...
def build_summary(store: PostgresStore, github_store, principal: Principal) -> dict:
    ...
    return {
        ...
        "audit": audit,
        "data_boundary": "Dashboard contains normalized delivery and audit facts; source code, diffs, PR bodies, logs and credentials are excluded.",
    }
