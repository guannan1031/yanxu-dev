...
只做安装体验时，也可以从 [v1.0.1 Release](https://github.com/guannan1031/yanxu-dev/releases/tag/v1.0.1) 下载 `yanxu_dev-1.0.1-py3-none-any.whl`；其 SHA-256 为 `7d6b33c86177da5308569b81921cb14fc5adf866eb4d17c8a355994f8617a804`。继续开发、运行仓库测试或启动 Docker Compose 时仍使用上面的 clone 流程。
